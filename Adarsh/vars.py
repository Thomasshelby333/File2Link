...
class Var(object):
    ...
    SESSION_NAME = str(getenv('SESSION_NAME', 'filetolinkdaaa'))
    ...
    if 'DYNO' in environ:
        ON_HEROKU = True
        APP_NAME = str(getenv('APP_NAME', 'filetolinkdaaa'))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', "mongodb+srv://think:think@cluster015.9oqeden.mongodb.net/?retryWrites=true&w=majority"))
